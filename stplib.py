...
class OfCtl_v1_2later(OfCtl_v1_0):
    ...
    def add_bpdu_pkt_in_flow(self):
        ...
        inst = [parser.OFPInstructionActions(ofp.OFPIT_APPLY_ACTIONS,
                                             actions)]
        mod = parser.OFPFlowMod(self.dp, table_id=1, priority=BPDU_PKT_IN_PRIORITY,
    ...
    def add_no_pkt_in_flow(self, in_port):
        ...
        mod = parser.OFPFlowMod(self.dp, table_id=1, priority=NO_PKT_IN_PRIORITY,
                                match=match)
        self.dp.send_msg(mod)
    ...
    def del_no_pkt_in_flow(self, in_port):
        ...
        match = parser.OFPMatch(in_port=in_port)
        mod = parser.OFPFlowMod(self.dp, table_id=1, command=ofp.OFPFC_DELETE_STRICT,
